...
int main(int argc, char *argv[]) {
  ...
  uint32_t ends[] = {5, 120, 126, 205, 226, 231};
  float values[] = {0.0f,  1.0f,   200.0f, -2.0f, 150.0f, 25.0f, 0.0f,  1.0f,   200.0f,
                    -2.0f, 150.0f, 25.0f,  -5.0f, -20.0f, 25.0f, -5.0f, -20.0f, 25.0f};
  ...
  // Add a new block of entries with a span. Since bwAdd/AppendIntervals was just used we MUST
  // create a new block
